                                  ...
                                  if ($result->num_rows > 0) {
                                    // output data of each row
                                        while($row = $result->fetch_assoc())
                                        {
                                            ...
                                            echo "<td><a class='btn btn-danger' href='delete-student.php?id=".$row['id']."'>Delete</a>";
                                            if($row['status']==1){
                                              echo "<a class='btn btn-danger mx-3'  href='action-student.php?id=".$row['id']."&status=0'>Deactivate</a>";
                                            }else{
                                                echo "<a class='btn btn-danger mx-3' href='action-student.php?id=".$row['id']."&status=1'>Activate</a>";
                                            }
                                      echo "</td>";
                                            echo "</tr>";
                                        }
