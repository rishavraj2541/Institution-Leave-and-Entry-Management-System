...
if (isset($_POST['staff_id']) && isset($_POST['password'])
	...
	if (empty($staff_id)) {
		...
		if (mysqli_num_rows($result) > 0) {
           ...
           $sql2 = "INSERT INTO staffs(staff_id, password, name,class,department,subject,status) VALUES('$staff_id', '$pass', '$name','$class','$department','$subject','0')";
           $result2 = mysqli_query($conn, $sql2);

           if ($result2) {
            $_SESSION['staff_id'] = $staff_id;
           	 header("Location: staff-registration.php?success=Your account has been created successfully,You can login after Activation.");
	         exit();
           }else {
