                                ...
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left">
                                        <div class="btn-group">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right" style=" background-color: black;">
                                                <a style="padding-left:10px;margin-left:0;background-color:black;" class="logout-button" href="logout.php">Logout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
          ...
          <div class="container" style="background-color:#53dcf3;">
               ...
               <center><label style="color:black;text-align:center;">Hello, <?php echo $_SESSION['name']; ?></u></label></center>
                    ...
                    <?php if (isset($_GET['success'])) { ?>
                         ...
                         <?php } else{ ?>
                    <form action="saveleaveform.php" method="post" style="margin:0 auto;" enctype="multipart/form-data">
                         ...
                         <div class="form-group">
                              <label for="reason">Supported documents</label>
                             <input type="file" name="image_01" require class="form-control">
                         </div>
                        <?php
